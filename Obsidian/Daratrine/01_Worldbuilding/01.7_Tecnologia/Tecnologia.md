...
A tecnologia anã de Gildrat nasce da relação entre **pedra, metal, mineração e sobrevivência imperial**.

Ela não é uma tecnologia leve, limpa ou ornamental. É uma tecnologia **pesada*, **visível**, **funcional** e marcada por fuligem, rebites, válvulas, forjas, placas de registro e ferramentas gastas.

O Império usa tecnologia para:
- extrair recursos;
- manter a cidade subterrânea viva;
- sustentar a Guarda de Ferro;
- controlar trabalhadores;
- reforçar a autoridade do Conselho;
- compensar a ausência de magia cotidiana.

> [!resumo]
> Gildrat é uma civilização de **engenharia mineral**. Sua tecnologia existe para escavar, forjar, ventilar, defender, registrar, cobrar, punir e sobreviver.


| Eixo              | Diretriz                                                                                                                                                                    |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Identidade        | Engenharia mineral, metalurgia, mineração, infraestrutura subterrânea e pragmatismo técnico.                                                                                |
| Nível tecnológico | Industrialização anã pré-moderna: mecânica pesada, combustão, forjas, hidráulica simples, alquimia aplicada e experimentos recentes.                                        |
| Relação com magia | Gildrat teme magia. A tecnologia compensa a ausência de magia cotidiana e tenta manter controle sobre artefatos raros.                                                      |
| Aparência         | Pedra polida, ferro, aço, latão, bronze, madeira escura, carvão, rebites, válvulas, chaminés, runas gravadas e placas de registro (referências de imagens no final do doc). |
| Função narrativa  | Mostrar domínio técnico, desigualdade social, ambição imperial, medo de perder controle e tensão entre progresso e tradição.                                                |
| Limite moral      | Tecnologia sem escuta ancestral vira violação: Melios é o exemplo central.                                                                                                  |
...
| Eixo                 | Definição                                                                                                |
| :------------------- | :------------------------------------------------------------------------------------------------------- |
| **Base material**    | Pedra, ferro, aço, bronze, latão, carvão, Kraven.                                                        |
| **Lógica técnica**   | Mecânica pesada, combustão, hidráulica simples, pressão de ar e alquimia aplicada.                       |
| **Estética**         | Pedra polida, metal escurecido, rebites, correntes, válvulas, chaminés, runas gravadas e fogo de tochas. |
| **Função social**    | Organizar trabalho, castas, mineração, guerra e circulação urbana.                                       |
| **Função narrativa** | Mostrar progresso, desigualdade, ambição imperial e ruptura com limites ancestrais.                      |
...
- **Função antes de beleza:** mesmo objetos nobres preservam aparência prática e resistente.
- **Técnica é poder:** controlar minas, forjas e máquinas significa controlar Gildrat.
- **Classe aparece no acabamento:** o pobre usa metal gasto; o nobre usa bronze polido.
- **Magia é suspeita:** mecanismos físicos substituem soluções mágicas.
- **Tradição pesa:** armas, ferramentas e muralhas carregam memória familiar ou imperial.


> [!Atenção]
> A tecnologia anã precisa partir da cultura de Gildrat: mineração, castas, ancestralismo, medo de magia e política imperial.
...
| **Madeira escura** | Painéis, cabos, suportes, mobiliário e combustão.       | Calor doméstico dentro da frieza da pedra.       |
| **Carvão**         | Forjas, lareiras, aquecimento e combustão urbana.       | Fuligem, trabalho e dependência energética.      |

---
## Tecnologias Comuns

São tecnologias que podem aparecer no cotidiano do jogador, de NPCs e de mapas comuns.

| Tecnologia                        | Onde aparece                         | Como descrever                                               |
| :-------------------------------- | :----------------------------------- | :----------------------------------------------------------- |
...
| **Baús de expedição**             | Frentes de mineração.                | Organização, cota, controle e posse.                         |

---
## Tecnologia Restrita, Perigosa ou Perdida
...
- forja no lugar de bênção;
- contrato no lugar de pacto;
- muralha no lugar de proteção espiritual.
