...
* **Visão Imperial:** "Pão e Circo". Uma válvula de escape para evitar revoltas nas minas. Financiam o esporte com função de controle social
* **Visão Popular:** Conexão com as Velhas Canções; sentimento de pertencimento, liberdade e poder. 
...
A transição da espiritualidade tradicional (Terra) para a pragmática imperial (Extração).
