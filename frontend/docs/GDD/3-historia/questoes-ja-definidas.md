...
As escolhas determinam quem estará disponível na fase seguinte e quais tipos de armadilhas poderão ser usadas.
...
| ------------------------- | ------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `v_sigmetal_destino`      | 0–3     | O destino do primeiro Sigmetal encontrado. Reflete a prioridade do jogador.              | Definido na Cena 7c.                                                                    | Determina a disponibilidade de um recurso/arma de Sigmetal no início da Fase 1.         |
| `v_influencia_corvos`     | 0–5     | O nível de confiança e colaboração com os Corvos.                                        | Aumenta ao colaborar com eles; diminui ao denunciá-los ou ignorá-los.                   | Desbloqueia rotas secretas, informações sobre Ignotos ou buffs de combate.              |
| `v_resgate_melios`        | 0–3     | O sucesso da operação de resgate em Melios.                                              | 0: Ninguém salvo. 1: Balastrus salvo. 2: Kilin salvo. 3: Ambos salvos.                  | Afeta a moral da Guarda de Ferro e a disponibilidade de NPCs chave.                     |
...
| `v_boa_vontade_thordan`   | 0–5     | O nível de respeito e entendimento entre Thorin e seu pai, Tordan.                        | Aumenta com diálogo respeitoso e atos alinhados à Guarda; diminui com rebeldia.         | Desbloqueia itens de família, conselhos táticos ou apoio direto de Tordan.             |
| `v_empatia_filena`        | 0–5     | A profundidade da conexão e confiança entre Thorin e Filena.                             | Aumenta ao apoiar Filena e suas causas.                                                 | Aprofunda o arco de relacionamento e pode desbloquear habilidades de combate em dupla.  |
| `v_folego_time_runico`    | 0–3     | A prontidão do time de futebol rúnico para atuar como uma unidade de suporte.            | 0: Inativo. 1: Reunido. 2: Treinado. 3: Equipado.                                       | Adiciona uma unidade de batedores/milícia de suporte na defesa de Gildrat.              |
| `v_alarme_ignotos`        | 0–9     | O quão cedo e com que precisão a liderança de Gildrat entende a ameaça dos Ignotos.      | Aumenta ao reportar informações precisas e encontrar evidências.                        | Afeta a velocidade e a qualidade da preparação defensiva de Gildrat.                    |
| `v_preparo_guarda_ferro`       | 0–9     | O nível de preparação tática e de recursos da Guarda de Ferro.                           | Aumenta ao ajudar na logística, completar missões de resgate e fortalecer defesas.      | Determina a força das linhas de frente durante a fase 3 da batalha final. |
| `v_preparo_civils`       | 0–9     | O nível de preparação tática e de recursos das unidades de civis.                           | Completar missões que acalmam e elevam a moral da população.     | Determina a força das linhas de civis durante a  fase 3 da batalha final. |
| `v_preparo_rebeldes`       | 0–9     | O nível de preparação tática e de recursos da Guarda de Ferro.                           | Aumenta ao ajudar o pai da Filena, completar missões de convencer e preparar os rebeldes.      | Determina a força das linhas de rebeldes durante a fase 3 da batalha final. |
