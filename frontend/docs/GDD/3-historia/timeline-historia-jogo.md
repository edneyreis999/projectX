# Timeline historia completa main quests

## 1 - A Noite da História (moldura narrativa)
...
## 4 - É Hora de Crescer: tentativa de fuga, armadura e taverna
...
## 5 - Primeiro Contrato: acordo com Balastrus e encontro com Tusk
...
## 6 - Minerador Aprendiz: Kravens, Cristaleão e o Sigmetal
...
## 7 - A Travessia Perigosa: nevasca e escolhas sobre o Sigmetal
...
Thorin recebe sua primeira paga e reconhecimento de Balastrus. Guardas convocam Balastrus ao conselho do Imperador Damburr; Thorin e Tusk são levados juntos, sob influência política que também envolve Tordan. Na audiência, a crise de recursos e rebeliões vem à tona. Filena é acusada injustamente de sedição. Balastrus capitaliza o momento e conquista o direito de explorar Melios — exigindo a presença de Thorin para legitimar a expedição. Após compras opcionais no mercado, o grupo parte para Melios.

## 9 - Chegada a Melios e confronto com os Corvos

Na clareira de Melios, o grupo “Corvos” bloqueia a passagem e relata ter encontrado um bloco de ferro rúnico com símbolos estranhos. O impasse vira combate — os Corvos atuam como uma boss fight — e, derrotados, se retiram, deixando o acesso livre. Balastrus confirma o início da exploração.
...
- Nomenclatura inconsistente a padronizar: “Gildrat/Gildrath”; “Reed/Rheed”; “Mhordred/Mordred”; “Dráqueis/Drakkeis/Drakeis”; “Sig Metal/Sigmetal”; times “Machados de Mithril/Machados Enferrujados”.
- “Alerta em Gildrat” e resposta do conselho/Imperador estão marcados como [gap a definir] nos materiais; requerem definição para continuidade do Ato II.
- Status de Kilin e Tharok após Melios permanece indefinido; alinhar flags de sobrevivência e possíveis retornos.
- Definir o 4º membro que atinge o pico ao lado de Thorin, Filena e Kilin [gap a definir].
- Clarificar desdobramentos sistêmicos do `v_sigmetal_destino` (entrega a Balastrus/Tusk/baú/ninguém) em relações, recompensas e falas nos capítulos seguintes.
- Garantir que a manifestação onírica de Thorin siga as regras de “Reino da Mana” já citadas na jornada; alinhar com taxonomia de técnicas sábias.
- Amarrar melhor o arco de Filena após a audiência (acusação no conselho) até sua presença no clímax; hoje a transição está só sugerida.
- Coerência política: amarrar a influência do “Profeta” sobre Damburr às decisões de risco (ex.: insistência em Melios), conforme world‑building citado.
