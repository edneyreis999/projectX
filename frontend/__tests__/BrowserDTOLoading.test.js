...
describe('Browser DTO Loading Tests', () => {
  ...
  test('Should load DTOs before domain classes', async () => {
    ...
    const domainPromises = [
      ...
      mockWindow.MineracaoUseCase ? Promise.resolve() : mockLoadScript('./js/application/MineracaoUseCase.js'),
    ];
  ...
  test('Should create domain instances after DTOs are loaded', async () => {
    ...
    await Promise.all([mockLoadScript('./js/domain/MinaKravensDomain.js'), mockLoadScript('./js/application/MineracaoUseCase.js')]);
