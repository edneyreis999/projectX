...
**Cutscene:** Teste de Template
**Mapa onde acontece:** `044`
...
| `Teste de Template` | `Kilin` | `sound` | `Bell3` | `false` | | |
| `Teste de Template` | `Kilin` | `focus zoom` | `in` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Ué, eu sempre acordo cedo!` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
| `Teste de Template` | `Mhordred` | `talk` | `E ontem?` | `true` | | |
| `Teste de Template` | `Kilin` | `balloon` | `3` | `true` | | |
| `Teste de Template` | `Kilin` | `sound` | `Item1` | `false` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Aquilo foi uma soneca estratégica.` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
| `Teste de Template` | `Mhordred` | `talk` | `Soneca estratégica?` | `true` | | |
| `Teste de Template` | `Kilin` | `shake` | `true` | `nan` | | |
...
| `Teste de Template` | `camera` | `tone` | `255,180,120,80,60` | `true` | | |
| `Teste de Template` | `camera` | `sound` | `Chime1` | `false` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Agora tudo tem um brilho aconchegante!` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
| `Teste de Template` | `Mhordred` | `talk` | `É bem aconchegante.` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Olha esse truque!` | `true` | | |
| `Teste de Template` | `Kilin` | `sound` | `Magic1` | `false` | | |
| `Teste de Template` | `Kilin` | `transparent` | `true` | `false` | | |
| `Teste de Template` | `wait` | `1` | `true` | `nan` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Ta-da! Tô invisível!` | `true` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
| `Teste de Template` | `Mhordred` | `talk` | `Você está transparente!` | `true` | | |
| `Teste de Template` | `Kilin` | `transparent` | `false` | `false` | | |
| `Teste de Template` | `Kilin` | `turn` | `right` | `false` | | |
| `Teste de Template` | `Kilin` | `sound` | `Item1` | `false` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
...
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
| `Teste de Template` | `Kilin` | `talk` | `Você consegue fazer o jogador desaparecer?` | `true` | | |
| `Teste de Template` | `Kilin` | `sound` | `Magic1` | `false` | | |
| `Teste de Template` | `player` | `transparent` | `true` | `false` | | |
| `Teste de Template` | `wait` | `1` | `true` | `nan` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
...
| `Teste de Template` | `Mhordred` | `sound` | `Item1` | `false` | | |
| `Teste de Template` | `camera` | `switch` | `44, on` | `false` | | |
| `Teste de Template` | `Mhordred` | `talk` | `Você venceu dessa vez!` | `true` | | |
| `Teste de Template` | `Kilin` | `balloon` | `1` | `true` | | |
| `Teste de Template` | `Kilin` | `sound` | `Bell2` | `false` | | |
| `Teste de Template` | `camera` | `switch` | `43, on` | `false` | | |
...
| `Teste de Template` | `camera` | `focus on` | `player` | `true` | | |
