...
* **Objetivo principal do jogador:** Atravessar a plateia, sentar‑se na primeira fileira e dizer seu nome a Rheed.
* **Emoção-âncora:** Maravilha com leve urgência.
* **Localizações centrais:** Praça Central de Daratrine (Mapa ID 005)
* **Personagens chave:** Theodore Rheed (narrador anão), Jogador‑criança (protagonista)
...
1. **Resumo de Premissa.** O protagonista se aproxima da fogueira, senta‑se à frente de Rheed, diz seu nome e é encoberto por fumaça que inicia a narrativa.
2. **Contexto Narrativo.** Noite clara de outono; praça com grande fogueira central; palco simples diante das chamas.
3. **Personagens.** Theodore Rheed (evento 017); Jogador‑criança; demais crianças (decorativos).
...
5. **Interatividade.**
   ...
   * Evento 017 Rheed (Action Button): sugere nome “João”; jogador confirma ou digita outro; define `v_player_name`; avança progress para 2.
...
8. **Cutscenes & Assets.** Sprite Theodore Rheed; sprite Jogador‑criança genérico.
