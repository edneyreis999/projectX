...
| Tipo | Descrição |
| --- | --- |
| Flags / Decisões anteriores | Retorno da Quest: "Quebra do selo em Mélios". |
| Limitações ou bloqueios | Sequência depende da escolha por defender Gildrat ao dormir. |
...
Quest: Quando o Segundo Sol Chegar - Fase Final
 ...
 +-- Cena 5: Confronto com o Chefe Ignoto
...
| Beat | Premissa Resumida | Tipo |
| ---- | ---------------- | ---- |
| **3-A - Avanço 1 dos Ignotos** | Os ignotos marcham em direção a Gildrat. | CS |
| **3-B - Armadilha 1** | Explode a primeira armadilha atingindo parte dos ignotos. | CS |
| **3-C - Avanço 2 dos Ignotos** | Ignotos marcham emm direção a Gildrat mais uma vez. | CS |
| **3-D - Armadilha 2** | Explode a segunda armadilha atingindo parte dos ignotos. | CS |
| **3-E - Avanço 3 dos Ignotos** | Os ignotos avançam mais uma vez | CS |
| **3-F - Armadilha 3** | Explode a terceira armadilha atingindo parte dos ignotos. | CS |
| **3-G - Thorin contra Ignotos** | Thorin aceita enfrentar os ignotos na travessia. | CS |
...
| Beat | Premissa Resumida | Tipo |
| ---- | ---------------- | ---- |
| **5-A - Chefe Ignoto** | Diálogo do chefe final com Thorin. | CS |
| **5-B - Thorin vs Chefe Ignoto** | O jogador se direciona até o Boss Final para enfrentá-lo. | JOG |
| **5-C - Vitória** | Texto  corresponde à vitória no jogo. | CS |
| **5-D - Texto Final** | Texto final do jogo com gancho para continuação. | CS |
| **5-C - Fim de Jogo** | O jogador finaliza o jogo. | CS |
