...
* **Premissa resumida:** Thorin é coagido a assinar um contrato de aprendiz de minerador com Balastrus e, sob a supervisão de Balastrus e três guardas imperiais, parte rumo à mina de Kravens.
...
* **Personagens chave:** Thorin (protagonista), Balastrus (mentor pragmático), Balastrus (líder da expedição), Killin (guarda‑chefe), Mhordred (guarda), Taverneiro.
...
### Cena 2 — “Entrega a Balastrus + Partida” ✅

| Item                   | Detalhe                                                                                                                                                                                                                                                                              |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Resumo de Premissa** | Thorin entrega o contrato a Balastrus, recebe sua primeira **Picareta de Mineração**, ouve Balastrus discutir com os guardas sobre vigiar o garoto e parte com o grupo rumo ao Mapamundi e à mina de Kravens.                                                                             |
...
| **Personagens**        | Thorin (PC), Balastrus, Filena, Borin, Guardas: Killin, Mhordred.                                                                                                                                                                                                                      |
...
| **Interatividade**     | • Entrega ➜ contrato removido, item **Picareta (I\_001)** adicionado.<br>• Cutscene na tenda (Balastrus × Guardas).<br>• Exploração opcional: rochas mineráveis (`EvtIDs 104‑106`) rendem loot se o jogador tiver a picareta.<br>• Partida segue Balastrus até a borda leste (Mapamundi). |
| **Fluxo Cronológico**  | Chegada via Teleporte 025 → entrega & picareta → cutscene tenda → exploração livre → conversa final ou borda leste → transição para Mapamundi → seguir Balastrus até evento de entrada da Mina.                                                                                           |
| **Gatilhos**           | `V_Q_PrimContrato_Progress = 2` (entrada) → **Entrega** ➜ `= 3` → **Saída Estrada 017** ➜ `= 4` (quest concluída).                                                                                                                                                                   |
| **Assets**             | Retratos: Balastrus, Filena, Killin, Mhordred; ícone picareta; Rochas Mineráveis; SFX fogueira, passos em cascalho, clang de mineração.                                                                                                                                         |
| **Integração**         | Mapa 017, Evento 001 (Balastrus), Evento 002 (Tenda/Balastrus), Evts 003‑005 (Guardas), Evts 104‑106 (Rochas mineráveis); variável `V_Q_PrimContrato_Progress`; item **Picareta** concedido.                                                                                              |
...
| ------------------------------------------------ | ------- | --------------------------------------- |
| IDs exatos de eventos para Balastrus, tenda e guardas | Baixo   | Definir ao implementar map 017          |
