...
* **Personagens chave:** Thorin (protagonista), Balastrus (mentor pragmático), Tusk (líder da expedição), Kilin (guarda‑chefe), Mhordred (guarda), Taverneiro.
...
| **Personagens**        | Thorin (PC), Tusk, Balastrus, Guardas: Kilin, Mhordred.                                                                                                                                                                                                                      |
...
| **Assets**             | Retratos: Tusk, Balastrus, Kilin, Mhordred; ícone picareta; Rochas Mineráveis; SFX fogueira, passos em cascalho, clang de mineração.                                                                                                                                         |
