...
| Tipo | Descrição |
|------|-----------|
| **Flags / Decisões anteriores** | Jogador concluiu a quest “Travessia Tóxica.” |
| **Limitações ou bloqueios** | Caminho principal do Mapamúndi bloqueado pela alcatéia de Lobos do Gelo. O confronto se torna inevitável. |
