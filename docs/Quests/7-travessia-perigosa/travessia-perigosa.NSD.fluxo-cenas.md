...
- **Conflito central**: Balastrus pressiona a equipe a partir em meio a uma tempestade de neve para apresentar os resultados da expedição, enquanto Thorin e os guardas enfrentam as consequências dessa decisão.  
...
- **Resumo**: A quest começa com uma discussão acalorada na clareira de Kravens sobre a iminente tempestade de neve. Balastrus insiste em partir imediatamente, ameaçando os membros que se recusarem com a perda de pagamento. Filena apoia Killin e lembra que precisa do pagamento, mas nao aceita morrer na neve. O grupo, incluindo Thorin, Killin, Mhordred, Filena e Borin, partem contrariados. Durante a travessia, uma forte avalanche separa o grupo. Thorin, Killin, Mhordred, Filena e Balastrus ficam juntos, mas são forçados a desviar por uma mina desconhecida, a Mina do Esgoto.
- **Locais principais**:  
  - Clareira de Kravens  
...
| **Limitações ou bloqueios** | Caminho principal do Mapamúndi aberto para retorno até a avalanche; único caminho disponível para dar a volta é através de uma caverna lateral desconhecida. |
...
Quest: A Travessia Perigosa
 ...
 │      ├── Beat 2: Debate entre Balastrus, guardas e mineradores (🎮) — múltiplas escolhas
...
| - | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1 | **Clareira de Kravens**     | Discussão tensa sobre a tempestade iminente; Killin alerta Balastrus sobre os riscos; jogador faz múltiplas escolhas para apoiar Killin ou Balastrus; Balastrus ameaça retenção de pagamento para quem não partir. |
| 2 | **Travessia no Mapamúndi**  | Retorno perigoso sob tempestade com batalhas contra inimigos fortalecidos; uma avalanche separa o grupo, forçando Thorin, Killin, Mhordred, Filena e Balastrus a encontrar um novo caminho pela Mina do Esgoto. |
...
| ---|-------------------------------------------------|-------------------------------------------------------|----------|
| 1  | Aviso de Killin                                   | Killin, chefe da guarda real, alerta Balastrus sobre a tempestade se formando e o perigo iminente.  | 🎬       |
| 2  | Reacao inicial do grupo                          | O grupo demonstra preocupacao; Filena apoia Killin e lembra que precisa do pagamento, mas nao aceita morrer na neve.               | ??       |
| 3  | Discordância de Balastrus                             | Balastrus nega o perigo e afirma que a missão deve continuar para cumprir o contrato.          | 🎬       |
| 4  | Debate acirrado                                  | Jogador pode escolher:                                     | 🎮       |
|     | — Apoiar Killin (sugerir esperar a tempestade passar)       | Reforça a cautela e tenta convencer os outros a adiar a partida.                           |          |
|     | — Apoiar Balastrus (incitar a partida imediata)                    | Ajuda Balastrus a pressionar o grupo a partir rapidamente.                                     |          |
| 5  | Cartada final de Balastrus                             | Balastrus reafirma sua autoridade, lembra o acordo com Balastrus e ameaça retenção de pagamento para quem não partir. | 🎬       |
| 6  | Decisão final do grupo                           | O grupo decide partir sob a pressão de Balastrus, mesmo contrariado.                           | 🎬       |

**Decisão do Jogador:**

- Apoiar Killin (sugerir esperar a tempestade passar).
- Apoiar Balastrus (insistir na partida imediata).
...
| 3  | Avalanche e Separacao                    | Uma forte avalanche separa o grupo. Thorin, Killin, Mhordred, Filena e Balastrus ficam juntos, mas isolados; Filena ampara Thorin e insiste em seguir. Borin e os outros expedicionarios ficam para tras. | ??       |
...
| 2  | Organização da entrega                          | Balastrus e os capatazes organizam o grupo em fila para entregar os minérios no baú de Kravens central.                      | 🎬       |
...
|     | — Se Balastrus já tem o Sigmetal (ou recebe antes) | Balastrus faz cena empolgada dizendo a Balastrus que ele encontrou o Sigmetal; Thorin reage, pois sabe que foi ele quem achou.|          |
