...
- Premissa resumida: Thorin, Killin, Mhordred, Filena e Balastrus chegam juntos ao ponto de reunião. Brutus já está lidando com os outros expedicionários que chegaram na frente. Balastrus assume
...
Quest: Barganha Sigmetal
 ...
 |      +-- Beat 1: Chegada conjunta do grupo (Thorin, Killin, Mhordred, Filena e Balastrus)
 ...
 +-- Cena 3: Encerramento do dia
        +-- Beat 1: Thorin nota a ausência de Thordan
...
| --- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| 1-A | Chegada conjunta             | Thorin chega com Killin, Mhordred, Filena e Balastrus. A cena reforca que todos atravessaram juntos e estão presentes no acerto final.                   | CS   |
...
| ID  | Titulo           | Premissa Resumida                                                                                      | Tipo |
| --- | ---------------- | ------------------------------------------------------------------------------------------------------ | ---- |
| 2-A | Grupo dispensado | Killin, Mhordred e Filena se despedem; o grupo deixa de atuar em bloco após o fechamento da negociação. | CS   |
...
| ID  | Titulo                  | Premissa Resumida                                                                                                    | Tipo |
| --- | ----------------------- | -------------------------------------------------------------------------------------------------------------------- | ---- |
| 3-A | Casa silenciosa         | Thorin chega em casa e percebe um clima incomum, com ausencia de Thordan no fim do dia.                               | JOG  |
