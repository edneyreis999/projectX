...
| Beat                      | Mapa/evento              | Participantes, posição e facing                                                                                | Lock                      | Diálogo                             | Movimento/animação                                                                       | Câmera/zoom                              | Áudio                                                                                                            | Await                                                                                         | Cleanup                                                         | Terminal/recovery                                             |
| ------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------- | ------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------------------------- |
| `BT-SEM-GAG-APPROACH-001` | Map063 E7                | Thorin `(15,21)` facing cima; jogadoras E2/E3/E4/E5 preservam posições baseline e convergem facing para Thorin | lock ativo                | nenhum                              | preservar retratos e reações baseline; aproximação legível sem caricatura nova           | câmera fixa no corredor/porta; zoom 100% | `CUE-SEM-STADIUM-BED-001`                                                                                        | nenhuma                                                                                       | nenhum                                                          | continua                                                      |
| `BT-SEM-GAG-LINE-001`     | Map063 E7                | `JOGADORA_VESTIARIO` ocupa anchor `MAP063_E7_LOCKER_PLAYER`; Thorin visível junto à porta                      | lock ativo                | `DL-SEM-GAG-LOCKER-001`, copy exata | reações podem continuar, mas ninguém esconde/move o anchor                               | câmera estável, zoom 100%                | beds cedem; ainda sem impacto                                                                                    | `WaitForGab: AW-SEM-GAG-LINE-001` protege a linha exata antes do impacto e recuo irreversível | nenhuma                                                         | continua                                                      |
| `BT-SEM-GAG-IMPACT-001`   | Map063 E7                | atacante do baseline alcança `(15,20)` facing Thorin; Thorin facing cima                                       | lock ativo                | nenhum                              | preservar Animation 39, impacto, movimento coletivo e recuo de Thorin um tile para baixo | sem shake novo, zoom 100%                | `CUE-SEM-GAG-IMPACT-001`; Animation 39 mantém `Thunder2/Thunder8/Blow3` e `Damage3` toca uma vez, sem duplicatas | rotas relevantes aguardadas; nenhuma Gab ativa                                                | atores retornam ao estado baseline autorado; one-shots terminam | Finish uma vez fora da área restrita; repeat/recovery estável |
| `BT-SEM-GAG-REPEAT-001`   | Map063 E7, página repeat | Thorin fora da área, facing porta                                                                              | lock somente da interação | `DL-SEM-GAG-LOCKER-REPEAT-001`      | nenhum impacto, perseguição ou rota coletiva                                             | câmera/zoom estáveis                     | somente bed                                                                                                      | nenhuma                                                                                       | fila não empilha                                                | controle retorna; rota masculina permanece visível            |
...
3. Dragobur mantém desespero, afeto, competência e dignidade; o gag preservado não ganha intensidade nova nem estereotipa as jogadoras.
