# Jornada do Jogador: A História de Ekios

*Este documento utiliza o framework da Jornada do Herói para estruturar a narrativa principal do jogo, preenchido com os eventos das quests iniciais.*
...
O mundo de Thorin é **Gildrat**, a capital do império anão. Sua vida é dividida entre a paixão pelo futebol rúnico — onde é um atacante talentoso — e a pressão de ser filho do General **Thordan Forja-Prata**. O status quo é a busca pela glória no esporte, em conflito direto com a autoridade e as expectativas de seu pai, que vê o esporte como uma atividade de “subúrbio” indigna do nome da família. As Cenas iniciais da timeline trazem detalhes que enriquecem o cotidiano e o conflito de Thorin.
...
- **Eventos Chave:**
  ...
  - **Confronto com Thordan:** De volta para casa, é escoltado por guardas. Tenta usar um troféu antigo do próprio pai como argumento, mas Thordan o humilha, chamando o troféu de “sucata brilhante”.
...
O chamado não é para uma aventura gloriosa, mas uma sentença. Thordan informa a Thorin que seu futuro como jogador acabou e que, na manhã seguinte, ele começará a trabalhar como aprendiz de explorador de minas. A missão é se apresentar a **Balastrus** na taverna. Este é o evento que perturba fundamentalmente o mundo de Thorin e o força a um novo caminho.

- **Eventos Chave:**
  - **Quest: Fim de Jogo:** Thordan impõe o novo destino a Thorin com a frase seca: “Então você vai trabalhar como minerador.”
...
- **Eventos Chave:**
  - **Quest: É Hora de Crescer:** Thorin tenta sair de casa para ir ao campo de futebol, mas é interceptado na porta pelos guardas **Killin** e **Mhordred**, que já previam sua desobediência por ordem de Thordan. A cena da compra da armadura termina com **Mhordred** pagando pelo equipamento de Thorin, marcando seu fracasso em continuar a recusar.
...
1. **Os Guardas (Killin, Mhordred):** Inicialmente antagonistas, eles se tornam aliados e mentores práticos, ensinando Thorin sobre o mundo real fora da nobreza de Gildrat, como na cômica cena da compra da armadura.
...
- **Aliados:** A relação com **Killin e Mhordred** se solidifica. Eles passam de meros guardas a companheiros de equipe, que o defendem e o ajudam. A presença de **Filena** no grupo também se torna uma constante.
...
- **Eventos Chave:**
  ...
  - **A Travessia Perigosa:** Debate entre a prudência de **Killin** e a pressa de **Tusk** sobre partir durante a nevasca; o grupo parte mesmo assim, enfrentando perigo elevado.
...
- **Eventos Chave:**
  ...
  - **Sacrifício Tático:** Para garantir a fuga, **Killin** fica para bloquear os inimigos enquanto grita para que **Thorin** fuja com **Mhordred** por uma passagem lateral. Eles alcançam a entrada da mina e batem em retirada rumo a Gildrat.
...
- **Ir para casa:** Leva à missão “Quando o Segundo Sol Chegar”, onde ele pode avisar **Thordan** sobre o ataque iminente.
...
Observação: Removidas menções às mortes de **Thordan** e **Mhordred** neste momento, pois não ocorrem nesta versão da timeline.
...
- Flags de sobrevivência/retorno de Killin após Melios. `[a definir]`
- Reação de Damburr e do conselho após o alerta. `[a definir]`
- Papel do Sigmetal no Ato II/III. `[a definir]`

---

## Pacing Narrativo: O Fluxo e Refluxo

O ritmo da jornada inicial é projetado para alternar entre momentos de alta tensão e alívio, mantendo o jogador engajado.
...
- **Pico (Alta Tensão):**
  ...
  - **Quest 3: Fim de Jogo:** Confronto emocional com Thordan.
...
- **Vale (Fuga Tensa):**
  - **Quest 7: A Travessia Perigosa:** Nevasca, debate Killin vs Tusk, retorno difícil.
